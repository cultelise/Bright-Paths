...
if (temperature >= 80 && rain) {
  console.log(
    'The weather is going to be warm and wet. Wear a light shirt, and take an umbrella.'
  );
} else if (temperature >= 60 && rain) {
  console.log('The weather is going to be cool and wet. Wear a rain-jacket.');
} else if (rain) {
  console.log(
    'The weather is cold and rainy. Wear a jacket and take an umbrella.'
  );
}

if (temperature >= 80 && !rain) {
  console.log('The weather is warm and dry. Wear light clothing.');
} else if (temperature >= 60 && !rain) {
  console.log('The weather is cool. Wear long sleeves.');
} else if (!rain) {
  console.log('The weather is cold. Wear a coat.');
}
