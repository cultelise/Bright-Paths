...
const nameCheck = (name) =>
  name.toLowerCase() === 'steven'
    ? 'What is up Steven?'
    : name.toLowerCase() === 'bryan'
    ? 'Hey Bryan!'
    : `Cool name, ${name}`;
...
const frogBuyer = (gold) => {
  let cost = 3;
  return `You can purchase ${Math.floor(gold / cost)} chocolate frogs.`;
};

const totalFrogs = frogBuyer(10000);
...
const frogBuyer2 = frogBuyer;
const totalFrogs2 = frogBuyer2(20);
...
const arrayIsAscending = checkAscending(sampleArray);
