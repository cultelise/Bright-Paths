...
// PROBLEM 3
/*
    Now you can see that the button colors change, but they do not change back 
    when we take the mouse off of the button.
...
sayHelloButton.addEventListener('mouseout', backgroundRevert);

// PROBLEM 4
/*
    Now lets see if we can make a request to our server when we click the button

    Add a 3rd event listener to sayHelloButton and trigger the sayHello function 
...
/*
    ...
    inside repeatMyParam function below  
...
const repeatMyParam = () => {
  axios
    .get('http://localhost:3000/repeat/Elise')
    .then((res) => {
...
const queryTest = () => {
  axios
    .get('http://localhost:3000/query-test/?name=Elise&is=lovely')
